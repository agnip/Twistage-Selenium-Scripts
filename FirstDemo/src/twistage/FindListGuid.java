...
public class FindListGuid {
    ...
    public static void main(String[] args) throws IOException, ParseException, InterruptedException, AWTException {
        ...
        //Login
        Thread.sleep(5000);
	    driver.findElement(By.id("login")).sendKeys("agnip.karmakar@hyland.com");
	    driver.findElement(By.id("password")).sendKeys("Hylandhyland@1234");
	...
	for (j=2;j<=870;j++) {
	    for (int i=1;i<=19;i=i+2)
	    {
	    	System.out.print(driver.findElement(By.
	    			xpath(VideoGuidFixedStart+"tr[" + i +"]"+VideoGuidFixedEnd)).getText());
